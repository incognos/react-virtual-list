...
/***/ function(module, exports, __webpack_require__) {
	...
	var VirtualList = function (_Component) {
	  ...
	  function VirtualList(props) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(VirtualList).call(this, props));
	    ...
	    _this.setState((0, _extends3.default)({
	      ...
	      scrollDelay: 0,
	      itemBuffer: 0
	    }, _this.getVirtualState(_this.props, true)));
	    return _this;
	  }

	  (0, _createClass3.default)(VirtualList, [{
	    key: 'getVirtualState',
	    value: function getVirtualState(props, initial) {
	      // default values
	      var state = {
	        items: [],
	        bufferStart: 0,
	      ...
	      viewBox.top = _utils2.default.viewTop(props.container);
	    ...
	    value: function shouldComponentUpdate(nextProps, nextState) {
	      ...
	      var equal = _utils2.default.areArraysEqual(this.state.items, nextState.items);

	      return !equal;
	    }
	  }, {
	    key: 'viewBox',
	    value: function viewBox(nextProps) {
	      return this.view = this.view || this._getViewBox(nextProps);
	    }
	  }, {
	    key: '_getViewBox',
	    value: function _getViewBox(nextProps) {
	      return {
	    ...
	    key: '_getListBox',
	    value: function _getListBox(nextProps) {
	      var list = _reactDom2.default.findDOMNode(this);

	      var top = _utils2.default.topDifference(list, nextProps.container);
	    ...
	    key: 'listBox',
	    value: function listBox(nextProps) {
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      this.onScrollDebounced = _utils2.default.debounce(this.onScroll, nextProps.scrollDelay, false);
	    ...
	    value: function componentWillMount() {
	      this.onScrollDebounced = _utils2.default.debounce(this.onScroll, this.props.scrollDelay, false);
	    }
	  }, {
	    ...
	    value: function render() {
	      var props = _lodash2.default.omit(this.props, 'items', 'itemHeight', 'renderItem', 'container', 'tagName', 'scrollDelay', 'itemBuffer');
...
/***/ function(module, exports) {
	...
	exports.topDifference = topDifference;
	exports.topFromWindow = topFromWindow;
